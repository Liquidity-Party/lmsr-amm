...
abstract contract PartyPoolBase is Test {
    ...
    function setUp() public virtual {
        ...
        (pool,) = Deploy.newPartyPoolWithDeposits("LP", "LP", tokens, kappa3, feePpm, false, deposits3, lpTokens3);
        ...
        (pool10,) = Deploy.newPartyPoolWithDeposits("LP10", "LP10", tokens10, kappa10, feePpm, false, deposits10, 0);
