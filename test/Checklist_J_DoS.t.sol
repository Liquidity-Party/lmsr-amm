...
contract Checklist_J_DoS is PartyPoolBase {
    ...
    function testChecklist_J1_BoundedLoopsAt10Tokens() public {
        ...
        pool10.mint(alice, Funding.APPROVAL, alice, lpAmount, new uint256[](10), 0, false, 0, bytes(""));
        ...
        gasBefore = gasleft();
        pool10.burn(alice, alice, lpAmount / 2, new uint256[](10), 0, false);
    ...
    ///      in PartyPoolBase.sol:101 and PartyPoolExtraImpl2.sol. We additionally
    ...
    function testChecklist_J2_NoTransferOrSendOnRefund() public {
        ...
        IPartyPool nativePool = Deploy.newPartyPool(
            "LPN", "LPN", tokens, kappa, 1000, weth, false, 1_000_000, 0
        );
    ...
    function testChecklist_J3_RevertingReceiverDoesNotBrickPool() public {
        ...
        IPartyPool localPool = Deploy.newPartyPool(
            "LPB", "LPB", tokens, kappa, 1000, weth, false, 1_000_000, 0
        );
        ...
        localPool.burn(alice, address(bad), totalLp / 8, new uint256[](2), 0, true);
        vm.stopPrank();
        ...
        localPool.burn(alice, alice, totalLp / 8, new uint256[](2), 0, false);
        ...
        localPool.burn(address(this), address(this), totalLp / 8, new uint256[](2), 0, false);
    }
