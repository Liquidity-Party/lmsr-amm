...
contract AllowanceTheftTest is PartyPoolBase {
    ...
    /// PartyPoolHelpers.sol:126 reverts before any token is pulled. D.10 (unauthorized
    ...
    function testAllowanceTheft_mint_reverts() public {
        ...
        vm.prank(bob);
        vm.expectRevert();
        pool.mint(alice, Funding.APPROVAL, bob, lpAmount, new uint256[](3), 0, false, 0, "");
    ...
    /// PartyPoolHelpers.sol:126 reverts before LP tokens can be redirected. D.10
    ...
    function testAllowanceTheft_swapMint_reverts() public {
        ...
        vm.prank(bob);
        vm.expectRevert();
        pool.swapMint(alice, Funding.APPROVAL, bob, 0, lpTarget, maxIn, 0, false, 0, "");
