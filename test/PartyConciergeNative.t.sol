...
contract PartyConciergeNativeTest is Test {
    ...
    function setUp() public {
        ...
        concierge = new PartyConcierge(planner, new PartyInfo(), IPermit2(address(0)), 500, 0, 300);
    ...
    function testMintWithEthForWrapperAsset() public {
        ...
        (uint256 lpMinted, ) = concierge.mint{value: 10 ether}(
            pool, alice, lpRequest, new uint256[](2), 0, false, 0, false
        );
        vm.stopPrank();
