...
contract InitialMintTest is Test {
    ...
    function testMint_revertsBeforeInitialMint_zeroAmount() public {
        ...
        vm.expectRevert();
        pool.mint(address(this), Funding.APPROVAL, address(this), 0, 0, "");
    }
    ...
    function testMint_succeedsAfterInitialMint() public {
        ...
        uint256 lpMinted = pool.mint(address(this), Funding.APPROVAL, address(this), lpRequest, 0, "");
