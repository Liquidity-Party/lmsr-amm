...
contract PartyPoolMintImpl is PartyPoolBase {
    ...
    returns (uint256 lpMinted) {
        ...
        require(isInitialDeposit, "initialized");
    ...
    returns (uint256 lpMinted) {
        ...
        bool isInitialDeposit = _totalSupply == 0;
        require(!isInitialDeposit, "uninitialized");
    ...
    function swapMintAmounts(
        ...
        require(netInternalGuess > int128(0), "too small");
        ...
        require(oldTotal > int128(0), "uninitialized");
        uint256 oldScaled = ABDKMath64x64.mulu(oldTotal, LP_SCALE);
    ...
    function swapMint(
        ...
        require(maxAmountIn > 0, "invalid amount");
        require(deadline == 0 || block.timestamp <= deadline, "deadline");
        require(_totalSupply > 0, "uninitialized");
