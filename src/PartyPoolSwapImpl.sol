...
contract PartyPoolSwapImpl is PartyPoolBase {
    ...
    function flashLoan(
        ...
        // Update cached balance: add the net fee (flashFee - protoShare) to existing balance
        _cachedUintBalances[tokenIndex] += (flashFee - protoShare);
    ...
    function swapToLimitAmounts(
        ...
        require(amountInUintNoFee > 0, "too small");
    ...
    function swapToLimit(
        ...
        require(inputTokenIndex < n && outputTokenIndex < n, "invalid index");
